...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=port)    resultado = sobrante - ganancias
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=10000)    sobrante = efectivo - gasolina - operativos
    ganancias = comision + extras_total + bono
...
if __name__ == "__main__":
    app.run()    sobrante = efectivo - gasolina - operativos
    ganancias = comision + extras_total + bono
